...
var addeventatc = (function () {
  ...
  return {
    ...
    toogle: function (e, t) {
      ...
      if (c) {
        ...
        'ios' == addeventatc.agent() &&
          ...
          'true' !== e &&
          'false' !== i &&
          ((s = 'appleical'), c.setAttribute('data-intel-apple', 'true'))
        try {
        ...
        if (
          ...
          'click' == t.type &&
            (addeventatc.click({ button: d, service: s, id: t.id }),
          ...
          for (
            var s, l = (h = (h += ',').replace(/ /gi, '')).split(','), r = 0;
            r < l.length;
            r += 1
          )
            ((f && 'ical' == l[r]) || (f && 'appleical' == l[r])) &&
              (n +=
              ...
              x &&
                ...
                (n +=
                  ...
                  A +
                  '</span>'),
              ((y && 'hotmail' == l[r]) || (y && 'outlookcom' == l[r])) &&
                (n +=
          ...
          addeventatc.getlicense(p) ||
            (n +=
              ...
              d +
              '-home" role="menuitem"></a></em></em>'),
            $d(d + '-drop') ||
              (((s = document.createElement('span')).id = d + '-drop'),
            ...
            $d(d + '-appleical') &&
              ($d(d + '-appleical').onclick = function () {
                addeventatc.click({ button: d, service: 'appleical', id: t.id })
              }),
            $d(d + '-google') &&
            ...
            $d(d + '-office365') &&
              ($d(d + '-office365').onclick = function () {
                addeventatc.click({ button: d, service: 'office365', id: t.id })
              }),
            $d(d + '-outlook') &&
    ...
    click: function (e) {
      ...
      if (c) {
        'home' == e.service
          ...
          : ((n = addeventatc.getburl({ id: e.button, facebook: !1 })),
            (t = window.configAeBaseUrl
              ? 'https://' +
                window.configAeBaseUrl +
                '/create/?service=' +
                e.service +
                n +
                '&reference=' +
            ...
            (d = n = ''),
            null !== (c = c.getAttribute('data-single')) &&
              'true' == c &&
              ((n = 'single/'), (d = '/single')),
            null !== a &&
              (t = addeventatc.usewebcal()
                ? window.configAeBaseUrl
                  ? 'webcal://' +
                    window.configAeBaseUrl +
                    '/event/' +
                ...
                : window.configAeBaseUrl
                  ...
                  : 'https://www.addevent.com/event/' +
                    ...
                    d)),
          $d('atecllink') ||
            (((i = document.createElement('a')).id = 'atecllink'),
            (i.rel = 'external'),
            i.setAttribute('data-role', 'none'),
            (i.innerHTML = '{addeventatc-ghost-link}'),
            (i.style.display = 'none'),
            document.body.appendChild(i))
        var i = $d('atecllink')
        if (
          ((i.target = o ? '_blank' : '_self'),
          window.configAeATCTarget && (i.target = window.configAeATCTarget),
          (i.href = t),
    ...
    show: function (e, t) {
      ...
      h &&
        f &&
        ('block' == addeventatc.getstyle(f, 'display')
          ? addeventatc.hideandreset()
    ...
    hideandreset: function (e) {
      ...
      e || (null != U && addeventatc.trigger('button_dropdown_hide', { id: t }))
    },
    getburl: function (e) {
      var t = $d(e.id),
        a = '',
    ...
    settings: function (e) {
      null != e.license && (p = e.license),
        ...
        null != e.outlook && null != e.outlook.show && (x = e.outlook.show),
        null != e.google && null != e.google.show && (w = e.google.show),
        null != e.office365 &&
    ...
    usewebcal: function () {
      ...
      navigator.userAgent.match(/CriOS|FxiOS|OPiOS|EdgiOS|mercury|gsa/i) &&
        (t = !0)
      ...
      if ((n && a) || (n && t)) {
        for (
          ...
          for (var s = c[i]; ' ' == s.charAt(0); ) s = s.substring(1, s.length)
